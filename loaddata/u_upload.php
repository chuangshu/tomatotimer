...
<!doctype html>
	...
	<script type="text/javascript">
	  ...
	  //----------------------------------------------------------休息时间计时---------------------------------------------	
		...
		if(imgObj.getAttribute("src",2)=="http://1.tomatotimer.applinzi.com/image/button/start.jpg"){
		imgObj.src="http://1.tomatotimer.applinzi.com/image/button/stop.jpg";
		alert("还没休息够呢~")
		}else{
		imgObj.src="http://1.tomatotimer.applinzi.com/image/button/start.jpg";
		alert("还没休息够呢~");
		}
		}
	...
	<body>
		...
		<div class="background">
			<div class="circle"><img width="250px" height="250px" src="http://1.tomatotimer.applinzi.com/image/tomato/circle.jpg"></div><!--若从sae中关闭要改变路径-->
			<div class="tomato"><img width="100px" height="100px" src="http://1.tomatotimer.applinzi.com/image/tomato/tomato.jpg"></div>
			<div class="brochure"><input type="image"  width="50px" height="50px"  src="http://1.tomatotimer.applinzi.com/image/button/brochure.jpg"></div>
			<div class="option"><input type="image" width="50px" height="50px" src="http://1.tomatotimer.applinzi.com/image/button/option.jpg"></div>
			<div class="record"><input type="image" width="50px" height="50px" src="http://1.tomatotimer.applinzi.com/image/button/record.jpg"></div>
			<div class="s"><input type="image" width="70px" height="70px" onClick="change_pic()" id="ss" src="http://1.tomatotimer.applinzi.com/image/button/start.jpg"></div> 
			<div class="oTime"><span id="oTime"></span></div> 
		</div> 
        <!--弹窗-->
		<div class="zhezhao" id="zhezhao"></div> 
		<div class="login" id="login"><span class="aa"><br/>提醒</span><br/><br/>又到了快乐的学习时间了~
		<button class="but" id="btclose" > <a href="http://1.tomatotimer.applinzi.com" title="点击进入">OK</a></button></div>   
